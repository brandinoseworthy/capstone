                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4 text-black">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <p class="mb-0"><a href="http://localhost:8080/playdateposts/user/${form.id}" class="text-muted">PlaydatePosts</a>  | <a href="http://localhost:8080/user/children/${form.id}" class="text-muted">View Children</a></p>
                            </div>
