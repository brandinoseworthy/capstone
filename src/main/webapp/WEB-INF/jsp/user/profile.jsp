                    ...
                    <div class="card">
                        <div class="rounded-top text-white d-flex flex-row"
                            ...
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                <img src="${form.imageURL}" class="img-fluid img-thumbnail mt-4 mb-2" name="imageURL"
                            ...
                            <div class="mb-5">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <p class="mb-0"><a href="http://localhost:8080/playdatepost/userposts"
                                                       class="text-muted">PlaydatePosts</a> | <a
                                            href="http://localhost:8080/user/mychildren" class="text-muted">View
                                        Children</a></p>
                                </div>
