                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form name="form1" action="/login/loginSubmit" method="POST">
                                        ...
                                        <form name="form1" action="#">
                                            ...
                                            <div class="pt-1 mb-4">
                                                ...
                                                <button class="btn btn-dark btn-lg btn-block" type="submit"
                                                        onclick="ValidateEmail(document.form1.username)"
                                                        style="background-color: #f38181;">
                                                    Login
                                                </button>
                                            </div>
                                        </form>
                                        <p><input type="radio"> <label class="form-label" for="form2Example27">Save
                                            Password</label></p>
